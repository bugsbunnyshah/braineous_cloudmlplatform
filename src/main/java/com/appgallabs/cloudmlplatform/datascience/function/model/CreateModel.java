package com.appgallabs.cloudmlplatform.datascience.function.model;
...
public class CreateModel {
    ...
    private com.appgallabs.cloudmlplatform.datascience.function.model.InputLayer[] inputLayers;
    private com.appgallabs.cloudmlplatform.datascience.function.model.OutputLayer[] outputLayers;

    public CreateModel(int seed,double learningRate,int inputs,String weight,
                            com.appgallabs.cloudmlplatform.datascience.function.model.InputLayer[] inputLayers,
                            com.appgallabs.cloudmlplatform.datascience.function.model.OutputLayer[] outputLayers)
    {
        this.seed = seed;
