...
import com.appgallabs.cloudmlplatform.datascience.utils.DownloaderUtility;
...
public class CSVDataModel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet ds = readCSVDataset("CSVPlotData.csv");
    ...
    private static DataSet readCSVDataset(String filename) throws IOException, InterruptedException {
        ...
        rr.initialize(new FileSplit(new File("CSVPlotData.csv")));
    ...
    private static DataSetIterator readCSVDatasetIterator() throws IOException, InterruptedException {
        /*int batchSize = 1000;
        RecordReader rr = new CSVRecordReader();
